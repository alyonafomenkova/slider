import { anyNumber, anything, capture, instance, mock, resetCalls, verify, when, } from 'ts-mockito';
import Presenter from '../../presenter/Presenter';
import Model from '../../model/Model';
// Mocks
const mockSliderView = mock();
const mockPointerFromView = mock();
const mockPointerToView = mock();
const mockScaleView = mock();
const initPresenter = (presenter) => {
...
const createConfiguration = (vertical) => ({
    min: 0,
    max: 100,
    step: 5,
    from: 20,
...
describe('Init presenter', () => {
    ...
    it('Subscribe to inner model', () => {
        ...
        let actualTo = -1;
        // Act
        presenter.setMaxListener((value) => { actualMax = value; });
        presenter.setMinListener((value) => { actualMin = value; });
        presenter.setStepListener((value) => { actualStep = value; });
        presenter.setValueFromListener((value) => { actualFrom = value; });
        presenter.setValueToListener((value) => { actualTo = value; });
        // Assert
...
//# sourceMappingURL=PresenterTest.js.map